...
func (g *Generator) getCCTemplate(f *descriptor.File) (string, error) {
	...
	pkgs := [][]string{
		...
		{"github.com/kukgini/cckit2/gateway", "cckit_gateway"},
		{"github.com/kukgini/cckit2/gateway/service", "cckit_ccservice"},
		{"github.com/kukgini/cckit2/router", "cckit_router"},
		{"github.com/kukgini/cckit2/router/param/defparam", "cckit_defparam"},
		{"github.com/kukgini/cckit2/router/param", "cckit_param"},
	}
